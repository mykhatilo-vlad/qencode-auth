...
import styles from './FieldPass.module.css';
...
const FieldPass = ({
    ...
    return (
        <div >
            <label>
                <span className={!showLabel ? 'fz-0' : ''}>{label}</span>

                <div className={styles.FieldPass}>
                    <input 
                        className={styles.FieldPassInput}
                        required
